...
@section('script')
	...
	<script type="text/javascript" src="/specifics/users/app.js"></script>
	<script type="text/javascript" src="/specifics/http-interceptors.js"></script>
	<script type="text/javascript" src="/specifics/users/controller.js"></script>
	<script type="text/javascript" src="/specifics/users/resources.js"></script>
@endsection
